...
import { ExternalBusinessManagementComponent } from './components/external-business-management/external-business-management.component';
...
@Component({
  ...
  imports: [
    ...
    ExternalBusinessManagementComponent
  ],
