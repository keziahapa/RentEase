...
@Component({
  selector: 'app-caretaker-pending-dashboard',
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
  ...
  templateUrl: './caretaker-pending-dashboard.component.html',
  styleUrls: ['./caretaker-pending-dashboard.component.scss']
})
export class CaretakerPendingDashboardComponent implements OnInit {
